...
import io.coinclave.crypto.applet.update.network.invoker.auth.ApiKeyAuth;
import io.coinclave.crypto.applet.update.network.invoker.auth.Authentication;
import io.coinclave.crypto.applet.update.network.invoker.auth.HttpBasicAuth;
...
public class ApiClient {
    ...
    private String basePath = BuildConfig.DATA_SERVICE_URL;
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://gateway.coinclave.io
    ...
    public <T> ApiResponse<T> execute(Call call, Type returnType) throws ApiException {
        try {
            ...
            System.out.println("RestAPI Response" + response.toString());
